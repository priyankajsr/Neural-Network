...
for i=1:m
tempCost = log(X3(i,y(i)))+sum(log(1-X3(i,:)))-log(1-X3(i,y(i)));
J = J+tempCost;
...
for t = 1:m
    yy = zeros(1, size(X3, 2));
    yy(y(t)) = 1;
    del3 = X3(t,:) - yy;
    del2 = del3*Theta2.*X2(t,:).*(1-X2(t,:));
    
   aalu1 =  X2(t,:)'*del3;
   aalu2 =  X(t,:)'*del2(:,2:end);
    
   Theta1_grad = Theta1_grad + aalu2';
   
   Theta2_grad = Theta2_grad + aalu1';
